...
- удаление "хардкод"-путей
- чистка "мёртвого кода"
- чек DIP (Dependency Inversion Principle) и SRP (Single Responsibility Principle)
- чек нарушений потокобезопасности
- чек слоёв

p.s. найти и убрать уже эту недостоверную информацию про RO DB's - вводит в заблуждение ревью.