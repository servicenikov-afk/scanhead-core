...
def to_nested(flat:dict)->dict:
	return {
		...
		'name':{'enabled':flat.get('name_enabled',True),'size':flat.get('name_size',7),'align':flat.get('name_align','center'),'max_lines':flat.get('name_max_lines',5),'bold':flat.get('name_bold',False),'italic':flat.get('name_italic',False),'offset_x':flat.get('name_offset_x',0),'offset_y':flat.get('name_offset_y',20),'prefix_article':flat.get('name_prefix_article',False),'truncate_for_km':flat.get('name_truncate_for_km',False),'max_models':flat.get('name_truncate_max_models',1)},
		'address':{'enabled':flat.get('address_enabled',True),'size':flat.get('address_size',6),'align':flat.get('address_align','right'),'bold':flat.get('address_bold',False),'italic':flat.get('address_italic',False),'offset_x':flat.get('address_offset_x',0),'offset_y':flat.get('address_offset_y',-165),'text_color':flat.get('address_text_color','#808080'),'bg_color':flat.get('address_bg_color','transparent')},
